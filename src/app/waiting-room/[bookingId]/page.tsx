  ...
  const fetchBooking = async () => {
    try {
      ...
      if (foundBooking.status === 'provider') {
        ...
        !['intake', 'ready-for-provider', 'confirmed'].includes(
          foundBooking.status
        )
      ) {
        router.push('/dashboard')
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Please wait while your healthcare provider prepares for your
            appointment
          </p>
        </div>
        ...
        <Card className="mb-6">
          <CardHeader>
            <CardTitle className="flex items-center justify-between">
              ...
              <Badge
                variant={
                  ['intake', 'ready-for-provider'].includes(booking.status)
                    ? 'default'
                    : 'secondary'
                }
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-700">
                      Your healthcare provider will join you shortly. Please
        ...
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>
              Please ensure the following for the best experience
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                <span className="text-sm">
                  Any relevant documents or questions ready
                </span>
              </div>
            </div>
          </CardContent>
