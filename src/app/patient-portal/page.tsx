...
export default function PatientPortal() {
  ...
  const telehealthAppointments = myBookings.filter(
    b => b.booking_type === 'online'
  )
  const inPersonAppointments = myBookings.filter(
    b => b.booking_type === 'pre-booked'
  )
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Manage your appointments and telehealth sessions
            </p>
          </div>
          ...
          <Card className="mb-8 border-blue-200 bg-blue-50">
            <CardHeader>
              <CardTitle className="text-blue-900">
                Active Telehealth Appointment
              </CardTitle>
              <CardDescription className="text-blue-700">
                You have an active telehealth appointment. Click the button
                below to join.
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <Card className="mb-8">
          <CardHeader>
            ...
            <CardDescription>
              Your online video consultation appointments
            </CardDescription>
          </CardHeader>
          <CardContent>
            {telehealthAppointments.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-500 mb-4">
                  No telehealth appointments scheduled
                </p>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Your scheduled visits to the healthcare facility
            </CardDescription>
          </CardHeader>
          <CardContent>
